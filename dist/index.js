...
var DevaController = class {
  ...
  async generateNewPost() {
    ...
    const context = composeContext({
      state: customState,
      template: ((_a = this.runtime.character.templates) == null ? void 0 : _a.devaPostTemplate) || DEVA_POST_TEMPLATE
    });
...
var DevaClient = class {
  ...
  async stop() {
    elizaLogger3.warn("Deva client does not support stopping yet");
  }
};
